...
internal sealed class GetSubjectDistribution : IEndpoint
{
  public void MapEndpoint(IEndpointRouteBuilder app)
  {
        ...
        HttpContext httpContext) =>
    {
      ...
      var query = new GetSubjectDistributionQuery { StudentId = studentId };
      var result = await sender.Send(query);

      return Results.Ok(new
      {
        status = StatusCodes.Status200OK,
        message = "Get subject distribution successfully",
        data = result
      });
    })
